...
{
    public partial class FormProspect : Form
    {
        ...
        public FormProspect(DateTime duskDateUTC, DateTime dawnDateUTC)
        {
            InitializeComponent();
        ...
        private void PropsectLaunch(DBQFileManagement.SearchType searchDB)
        {
        ...
        private void SelectGalaxyButton_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (SelectGalaxyButton.Checked)
            {
                ...
                PropsectLaunch(DBQFileManagement.SearchType.Galaxy);
        ...
        private void SelectClusterButton_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (SelectClusterButton.Checked)
            {
                ...
                PropsectLaunch(DBQFileManagement.SearchType.Cluster);
        ...
        private void SelectNebulaButton_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (SelectNebulaButton.Checked)
            {
                ...
                PropsectLaunch(DBQFileManagement.SearchType.Nebula);
